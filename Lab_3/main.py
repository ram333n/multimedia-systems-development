...
def demo(input_image_name, dct_image_name, dwt_image_name):
    input_image = read_image(input_image_name)
...
def main():
    ...
    output_image_name_dct = 'dct_compressed_2.png'
    ...
    print(f'PSNR: {psnr_by_names(input_image_name, output_image_name_dct)} dB')

    demo(input_image_name, output_image_name_dct, None)
